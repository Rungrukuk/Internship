...
if (isset($_GET["id"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (!isset($_GET['csrf_token_update']) || $_GET['csrf_token_update'] !== $_SESSION['csrf_token_update']) {
            // CSRF token doesn't match or is missing, reject the form submission
            header('HTTP/1.1 400 Bad Request');
            echo 'CSRF token mismatch';
            exit;
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="date" name="startTime" value="<?php echo $startTime ?>" required>
                            </div>
                            <div class="input-box">
                                ...
                                <input type="date" name="finishTime" value="<?php echo $finishTime ?>" required>
                            </div>
                            <div class="input-box">
